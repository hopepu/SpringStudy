...
public class BoardController {
	...
	private BoardService service;
	  ...
	  @PostMapping("/list") public void list2(Criteria cri, Model model) {
	  log.info("BoardController.list method activate with Criteria" + cri);
	...
	public void get(@RequestParam("bno") Long bno, @ModelAttribute("cri") Criteria cri, Model model) {
		log.info("BoardController.get or modify method activate");
